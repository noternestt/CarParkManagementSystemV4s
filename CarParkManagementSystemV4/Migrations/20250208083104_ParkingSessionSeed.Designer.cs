...
namespace CarParkManagementSystemV4.Migrations
{
    ...
    [Migration("20250208083104_ParkingSessionSeed")]
    partial class ParkingSessionSeed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarParkManagementSystemV4.Data.CarParkManagementSystemV4User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b1fd743c-3774-4212-8de3-f552e1d7aba4",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENM5KXjVDbNpVJxVG28wMM7N5RGv6FNJq4aMGKLkOSyYXut3y3F+ThLvsBQQ3dw0aA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "7f0f2f37-b269-4ea3-8aae-4ef687fdb30d",
            ...
            modelBuilder.Entity("CarParkManagementSystemV4.Domain.ParkingSession", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2025, 2, 8, 16, 31, 3, 202, DateTimeKind.Local).AddTicks(7872),
                            DateUpdated = new DateTime(2025, 2, 8, 16, 31, 3, 202, DateTimeKind.Local).AddTicks(7872),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "system",
                            Date = new DateTime(2025, 2, 8, 0, 0, 0, 0, DateTimeKind.Local),
                            DateCreated = new DateTime(2025, 2, 8, 16, 31, 3, 202, DateTimeKind.Local).AddTicks(7876),
                            DateUpdated = new DateTime(2025, 2, 8, 16, 31, 3, 202, DateTimeKind.Local).AddTicks(7877),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "system",
                            Date = new DateTime(2025, 2, 8, 0, 0, 0, 0, DateTimeKind.Local),
                            DateCreated = new DateTime(2025, 2, 8, 16, 31, 3, 202, DateTimeKind.Local).AddTicks(7879),
                            DateUpdated = new DateTime(2025, 2, 8, 16, 31, 3, 202, DateTimeKind.Local).AddTicks(7880),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2025, 2, 8, 16, 31, 3, 202, DateTimeKind.Local).AddTicks(7902),
                            DateUpdated = new DateTime(2025, 2, 8, 16, 31, 3, 202, DateTimeKind.Local).AddTicks(7902),
            ...
            modelBuilder.Entity("CarParkManagementSystemV4.Domain.VisitedLocations", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarParkManagementSystemV4.Domain.Pricing", b =>
                {
                    b.HasOne("CarParkManagementSystemV4.Domain.Location", "Location")
                        .WithMany()
